...
public class UserService implements UserDetailsService {
  ...
  private static final String FIND_ALL_LOG = "Fetching all users";
  private static final String FIND_LOG = "Fetching user {}";
  private static final String CREATE_LOG = "Creating user {}";
  private static final String UPDATE_LOG = "Updating user {}";
  private static final String DELETE_LOG = "Deleting user {}";
  private static final String ADD_ROLE_LOG = "Adding role {} to user {}";
